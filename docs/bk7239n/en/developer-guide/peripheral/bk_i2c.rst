...
Beken The chip usually has two I2C controllers, and BK7239 supports three I2Cs (I2C0, I2C1, and I2C2).
...
.. note::
  ...
  For bk7239n/bk7231n/bk7251, I2C_ID_1 (corresponding to I2C2 on address_mapping) shares GPIO with UART2, so when I2C_ID_1 is enabled, UART2 cannot be used.
