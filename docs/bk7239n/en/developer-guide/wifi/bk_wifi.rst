...
- Support both HT20/40, VHT20/40, HE20
- Support 802.11N MCS0-7, 802.11AC MCS0-9, 802.11AX MCS0-9
...
- All above three macro definitions are located in ``middleware\soc\bk7239n\bk7239n.defconfig`` ,with default values of y
