...
Taking the bk7239n chip as an example, refer to /projects/app to create a new project/projects/template. The project directory structure is as follows:
...
If there is a need to modify the partition, to facilitate the modification, you usually need to follow the following steps:
    ...
    - Modify partition information based on the automated partition CSV table config/bk7239n/bk7239n_partitions.csv
    ...
    - Compile the project template - Compile the server shell terminal and enter make bk7239n PROJECT=template
    ...
    You can see that the files config/bk7239n/configuration.json and config/bk7239n/partitions.csv have been added to the project directory.At the same time,The contents of the main/vendor_flash.c and main/vendor_flash_partition.h files will be updated simultaneously.