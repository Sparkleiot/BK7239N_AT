...
Run following commands to build BK7239 app project::
...
You can build other projects with PROJECT parameter, e.g. run "make bk7239n PROJECT=security/secureboot" 
