...
- :ref:`pm<pm-pm>`             :平台power manager

- :ref:`pm_vote<pm-pm_vote>`   :WIFI保活来唤醒低压设备


.. _pm-pm:

:ref:`pm<pm-cli>` **:平台power manager(normal sleep、low voltage 、deepsleep)**
------------------------------------------------------------------------------------------
...
:ref:`pm_vote<pm-cli>`  **:WIFI保活来唤醒低压设备**
-------------------------------------------------------------------------------------
