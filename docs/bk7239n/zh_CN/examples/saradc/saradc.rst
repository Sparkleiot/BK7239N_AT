...
2、代码路径
--------------------------
	路径: ``middleware\driver\saradc\adc_test.c``
...
４、API参考
--------------------------
    网页API参考中外设里包含对saradc的API进行介绍:https://docs.bekencorp.com/armino/bk7256/zh_CN/latest/api-reference/peripheral/bk_adc.html
