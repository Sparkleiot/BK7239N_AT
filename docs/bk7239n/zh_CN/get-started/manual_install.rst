...
点击 `下载 <https://dl.bekencorp.com/tools/toolchain/arm/gcc-arm-none-eabi-10.3-2021.10-x86_64-linux.tar.bz2>`_ 下载 BK7239 工具链。
...
.. note::
    ...
    工具链默认路径在 middleware/soc/bk7239n/bk7239n.defconfig 文件中定义，您也可以在项目配置文件中更改工具链路径::
...
.. note::
    ...
    通常您不需要自己编译 Armino 文档，点击进入 `文档 <https://docs.bekencorp.com/arminodoc/bk_idk/bk7239n/zh_CN/v2.0.1/index.html>`_ 您就可以查看 Armino 最近或者最新的文档。
