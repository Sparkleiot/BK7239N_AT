...
.. note::
    ...
    工具链默认路径在 middleware/soc/bk7239n/bk7239n.defconfig 文件中定义，如果您更改了工具链路径，需要在配置文件中重新配置工具链路径::
...
您可以通过 PROJECT 参数来编译 projects 下其他工程，如 make bk7239n PROJECT=security/secureboot
