...
//spi enable _ok
#define addSYSTEM_Reg0xa                       (*((volatile unsigned int *)(BK3000_SYS_BASE_ADDR + 0xa*4)))
#define SPI0_CLK_80M                           addSYSTEM_Reg0xa |= (0x2 << 4)
#define SPI0_ENABLE                            addSYSTEM_Reg0xc |= 0x2
#define SPI0_DISABLE                            addSYSTEM_Reg0xc &= ~0x2
...
#define Beken_Write_Register(addr, data) (*((volatile uint32_t *)(addr))) = (uint32_t)(data);
#define Beken_Read_Register(addr) (*(volatile uint32_t *)(addr));
