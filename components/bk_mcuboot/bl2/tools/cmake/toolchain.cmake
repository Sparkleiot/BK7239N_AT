...
if(NOT BL2_TOOLCHAIN_FILE)
	message(DEPRECATION "SETTING CMAKE_TOOLCHAIN_FILE is deprecated. It has been replaced with BL2_TOOLCHAIN_FILE.")
    return()
endif()
...
set(CMAKE_USER_MAKE_RULES_OVERRIDE tools/cmake/set_extensions.cmake)

macro(bl2_toolchain_reset_compiler_flags)
...
macro(bl2_toolchain_reset_linker_flags)
...
macro(bl2_toolchain_set_processor_arch)
...
macro(bl2_toolchain_reload_compiler)
    bl2_toolchain_set_processor_arch()
    bl2_toolchain_reset_compiler_flags()
    bl2_toolchain_reset_linker_flags()
...
# done, all further compiler setup is done via bl2_toolchain_reload_compiler()
