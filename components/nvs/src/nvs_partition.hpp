...
public:
     ...
     */
    NVSPartition(const bk_logic_partition_t* partition);
     ...
     */
    bk_err_t read_raw(size_t src_offset, void* dst, size_t size) override;
     ...
     *      - other error codes from the esp_partition API
     */
    bk_err_t read(size_t src_offset, void* dst, size_t size) override;
     ...
     */
    bk_err_t write_raw(size_t dst_offset, const void* src, size_t size) override;
     ...
     *      - other error codes from the esp_partition API
     */
    bk_err_t write(size_t dst_offset, const void* src, size_t size) override;
     ...
     *      - error codes from the esp_partition API
     */
    bk_err_t erase_range(size_t dst_offset, size_t size) override;
...
protected:
    const bk_logic_partition_t* mESPPartition;
	bk_partition_t partition_id;
};
