 ...
 */
bk_err_t nvs_open(const char* namespace_name, nvs_open_mode_t open_mode, nvs_handle_t *out_handle);
 ...
 *             - other error codes from the underlying storage driver
 */
bk_err_t nvs_open_from_partition(const char *part_name, const char* namespace_name, nvs_open_mode_t open_mode, nvs_handle_t *out_handle);
 ...
 */
bk_err_t nvs_set_i8 (nvs_handle_t handle, const char* key, int8_t value);
 ...
 */
bk_err_t nvs_set_u8 (nvs_handle_t handle, const char* key, uint8_t value);
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
bk_err_t nvs_set_i16 (nvs_handle_t handle, const char* key, int16_t value);
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
bk_err_t nvs_set_u16 (nvs_handle_t handle, const char* key, uint16_t value);
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
bk_err_t nvs_set_i32 (nvs_handle_t handle, const char* key, int32_t value);
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
bk_err_t nvs_set_u32 (nvs_handle_t handle, const char* key, uint32_t value);
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
bk_err_t nvs_set_i64 (nvs_handle_t handle, const char* key, int64_t value);
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
bk_err_t nvs_set_u64 (nvs_handle_t handle, const char* key, uint64_t value);
 ...
 */
bk_err_t nvs_set_str (nvs_handle_t handle, const char* key, const char* value);
/**@}*/
 ...
 */
bk_err_t nvs_set_blob(nvs_handle_t handle, const char* key, const void* value, size_t length);
 ...
 * bk_err_t err = nvs_get_i32(my_handle, "max_buffer_size", &max_buffer_size);
 ...
 */
bk_err_t nvs_get_i8 (nvs_handle_t handle, const char* key, int8_t* out_value);
 ...
 */
bk_err_t nvs_get_u8 (nvs_handle_t handle, const char* key, uint8_t* out_value);
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
bk_err_t nvs_get_i16 (nvs_handle_t handle, const char* key, int16_t* out_value);
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
bk_err_t nvs_get_u16 (nvs_handle_t handle, const char* key, uint16_t* out_value);
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
bk_err_t nvs_get_i32 (nvs_handle_t handle, const char* key, int32_t* out_value);
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
bk_err_t nvs_get_u32 (nvs_handle_t handle, const char* key, uint32_t* out_value);
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
bk_err_t nvs_get_i64 (nvs_handle_t handle, const char* key, int64_t* out_value);
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
bk_err_t nvs_get_u64 (nvs_handle_t handle, const char* key, uint64_t* out_value);
/**@}*/
 ...
 */
bk_err_t nvs_get_str (nvs_handle_t handle, const char* key, char* out_value, size_t* length);
 ...
 */
bk_err_t nvs_get_blob(nvs_handle_t handle, const char* key, void* out_value, size_t* length);
/**@}*/
 ...
 *              - other error codes from the underlying storage driver
 */
bk_err_t nvs_erase_key(nvs_handle_t handle, const char* key);
 ...
 *              - other error codes from the underlying storage driver
 */
bk_err_t nvs_erase_all(nvs_handle_t handle);
 ...
 *             - other error codes from the underlying storage driver
 */
bk_err_t nvs_commit(nvs_handle_t handle);
 ...
 */
bk_err_t nvs_get_stats(const char *part_name, nvs_stats_t *nvs_stats);
 ...
 *               Return param used_entries will be filled 0.
 */
bk_err_t nvs_get_used_entry_count(nvs_handle_t handle, size_t* used_entries);
 ...
 *  bk_err_t res = nvs_entry_find(<nvs_partition_name>, <namespace>, NVS_TYPE_ANY, &it);
 *  while(res == ESP_OK) {
 ...
 */
bk_err_t nvs_entry_find(const char *part_name,
 ...
 */
bk_err_t nvs_entry_next(nvs_iterator_t *iterator);
 ...
 */
bk_err_t nvs_entry_info(const nvs_iterator_t iterator, nvs_entry_info_t *out_info);
