...
void rwnx_cal_set_txpwr_by_rate(INT32 rate, UINT32 format, UINT32 pwr_gain, UINT32 test_mode, UINT32 ru, UINT32 bw);
UINT8 rwnx_cal_get_pwr_idx(void);
...
void rx_get_rx_result_end_for_mbp_ate(void *param, void *reset_stat);
