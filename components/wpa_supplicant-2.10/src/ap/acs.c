...
bw_selected:
	...
	if (ideal_chan) {
		...
		WPA_LOGI("ACS: Ideal channel is %d (%d MHz) with total interference factor of %Lg\n",
...
{
#ifdef CONFIG_NO_STDOUT_DEBUG
	WPA_LOGI("ACS: Automatic channel selection started, this may take a bit\n");
#else
