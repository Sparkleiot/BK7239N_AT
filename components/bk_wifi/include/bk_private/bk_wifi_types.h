...
#define WIFI_WIRELESS_MODE_B   1
#define WIFI_WIRELESS_MODE_BG  2
#define WIFI_WIRELESS_MODE_BGN 3
...
typedef struct sta_param {
	...
	uint16_t auth_retry_interval;
	uint16_t assoc_retry_interval;
#endif
#ifdef CONFIG_STA_MINMUM_SECURITY
	uint8_t sta_cipher_suite;
#endif
...
typedef  struct  _ScanResult_adv
{
	...
	struct ApListStruct
	{
		...
		uint8_t is_bridge; /**< Is it bridge AP */
