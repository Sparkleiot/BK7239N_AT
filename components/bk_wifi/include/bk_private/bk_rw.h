...
extern int rw_msg_send_channel_update_req(u8 channel);
...
extern int rw_msg_send_wireless_mode_req(uint8_t wireless_mode);
extern int rw_msg_send_retry_config_req(uint8_t auth_retry, uint16_t auth_retry_interval,
		uint8_t assoc_retry, uint16_t assoc_retry_interval);
extern int rw_msg_get_tx_frame_count_req(void *cfm);
extern int rw_msg_get_rx_frame_count_req(void *cfm);
extern int rw_msg_send_sleep_mode_req(uint8_t sta_idx, uint8_t sleep_mode);
...
extern int rw_msg_get_sleep_mode_req(void *cfm);
...
extern int rw_msg_set_channel(uint32_t prim_channel, uint32_t second_channel, uint32_t band_width, void *cfm);
