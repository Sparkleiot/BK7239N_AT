...
__INLINE void rwnx_update_tx_use_max_bw(uint32_t use_max_bw)
{
	rwnx_mod_params.tx_use_max_bw = !!use_max_bw;
	RWNX_LOGI("update use max bw:%d\n", !!use_max_bw);
}
