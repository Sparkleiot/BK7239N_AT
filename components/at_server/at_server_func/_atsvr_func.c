...
extern void atsvr_echo_set(int en_flag);
#if CONFIG_SHELL_ASYNCLOG
extern void shell_echo_set(int en_flag);
#endif

static void at_echo_apply(int en_flag)
{
	atsvr_echo_set(en_flag);
#if CONFIG_SHELL_ASYNCLOG
	shell_echo_set(en_flag);
#endif
}
