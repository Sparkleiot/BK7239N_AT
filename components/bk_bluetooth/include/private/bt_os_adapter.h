...
struct bt_osi_funcs_t
{
    ...
    void (*_ble_enter_dut_set_vanaldosel)(uint8_t value);
    void (*_ble_enter_dut_set_xtalh_ctune)(uint8_t value);
    uint8_t (*_ble_enter_dut_get_xtalh_ctune)(void);
    #endif
    ...
    int (*_bk_feature_dsss_only_enable)(void);
    void (*_coex_bt_request)(uint32_t event,uint8_t mode,uint32_t duration);
    void (*_coex_bt_release)(uint32_t event);
};
