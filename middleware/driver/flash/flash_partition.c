...
static bool partition_is_encrypt(bk_logic_partition_t *partition_info)
{
    uint8_t* buf = NULL;
...
static bk_err_t flash_partition_addr_check(const bk_logic_partition_t *partition_info, uint32_t offset, uint32_t size)
{
