...
#define SDIO_TX_PACK_FULL_TIMEOUT (100)
...
typedef union
{
	struct
	{
	   volatile uint32_t  cmd_s_rec_index_buf0			 : 6;  //0x40[5:0], buf save CMD index of 1st,0x0,R
	   volatile uint32_t  cmd_s_rec_index_buf1			 : 6;  //0x40[11:6],buf save CMD index of 2nd,0x0,R
	   volatile uint32_t  cmd_s_rec_index_buf2			 : 6;  //0x40[17:12],buf save CMD index of 3rd,0x0,R
	   volatile uint32_t  cmd_s_rec_index_buf3			 : 6;  //0x40[23:18],buf save CMD index of 4th,0x0,R
	   volatile uint32_t  cmd_s_rec_index_buf4			 : 6;  //0x40[29:24],buf save CMD index of 5th,0x0,R
...
#else
#define GPIO_SDIO_NOTIFY_HOST (GPIO_36)
#endif
#endif
