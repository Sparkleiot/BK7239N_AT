...
static void cli_gpio_help(void)
{
	...
	CLI_LOGI("gpio_mulcore_isr", "gpio_mulcore_isr [cpu0_output_gpio_id]   [iterations]\r\n");
	CLI_LOGI("gpio_clk    [32k/26m]\r\n");
...
#endif
#if CONFIG_SYS_CPU1
	CLI_LOGI("gpio_cpu1_set_id [cpu1_output_gpio_id]\r\n");
#endif
}
...
static void cli_gpio_cpu1_set_id_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
	...
	CLI_LOGI("rtos_create_thread SUCCESS\r\n");
...
static void cli_gpio_clk_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
	...
	if (os_strcmp(argv[1], "32k") == 0)
	{
		...
		CLI_LOGI("unkown input frequency, current frequency is %d\r\n", gpio_clksel);
	}
#endif
}
...
static void cli_gpio_ate_test_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
	bk_gpio_ate_test();
}
#endif
...
#endif
#if CONFIG_GPIO_ATE_TEST
	{"gpio_ate_test", "gpio_ate_test", cli_gpio_ate_test_cmd}
#endif
};
