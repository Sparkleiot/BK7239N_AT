...
void sys_hal_set_efstoflash_otp(uint8_t load, uint8_t shaddr, uint8_t en);
...
uint32_t sys_hal_analog_get_iram(analog_reg_t reg);
//Yantao Add Start
...
void sys_hal_set_deep_lv_boot_addr(uint32_t msp, uint32_t pc);
