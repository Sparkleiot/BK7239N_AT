...
#define PD_MEM5         (BIT(14))
#define PD_ROM          (BIT(15))
#define PD_MEM          (PD_MEM0 | PD_MEM1 | PD_MEM2 | PD_MEM3 | PD_MEM4 | PD_MEM5) //TODO consider TCM/MEM low power

/*ahbp power domain control*/
#if CONFIG_AHBP_POWER_DOMAIN_LV_DISABLE
