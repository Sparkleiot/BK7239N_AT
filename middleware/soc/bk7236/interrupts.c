...
#define TAG "int"
#define InterruptMAX_IRQn INT_ID_MAX

typedef uint32_t IRQn_Type;
extern void arch_int_init_all_irq(void);
...
void __attribute__ ((interrupt)) SCR7816_Handler(void)
{
	ARCH_ISR_HANDLER(60);
}
...
#if CONFIG_SOC_BK7236_SMP_TEMP || CONFIG_SOC_BK7239N_SMP_TEMP
