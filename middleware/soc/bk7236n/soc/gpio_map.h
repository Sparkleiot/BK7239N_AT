...
{\
	{GPIO_CLK_PIN_SRC_ROSC,     {GPIO_13,      CLK_PIN_ANA_ROSC   }, {GPIO_23,      GPIO_DEV_LPO_CLK,  CLK_PIN_DIG_LPO_CLK_ROSC     }},\
	{GPIO_CLK_PIN_SRC_XTALL,    {GPIO_13,      CLK_PIN_ANA_XTAL   }, {GPIO_23,      GPIO_DEV_LPO_CLK,  CLK_PIN_DIG_LPO_CLK_XTALL    }},\
	{GPIO_CLK_PIN_SRC_XTALH,    {GPIO_NUM_MAX, CLK_PIN_ANA_INVALID}, {GPIO_22,      GPIO_DEV_CLK_XTAL, CLK_PIN_DIG_XTAL             }},\
	{GPIO_CLK_PIN_SRC_XTALHD,   {GPIO_NUM_MAX, CLK_PIN_ANA_INVALID}, {GPIO_6,       GPIO_DEV_CLK_XTAL_DIV, CLK_PIN_DIG_XTAL_DIV     }},\
	{GPIO_CLK_PIN_SRC_XTALH32K, {GPIO_NUM_MAX, CLK_PIN_ANA_INVALID}, {GPIO_23,      GPIO_DEV_LPO_CLK,  CLK_PIN_DIG_LPO_CLK_XTALH    }},\
...
#define SDIO_GPIO_PIN_NUMBER    6
#else
#define SDIO_GPIO_PIN_NUMBER    3
#endif

#define SDIO_GPIO_CLK_INDEX     0
#define SDIO_GPIO_CMD_INDEX     1
#define SDIO_GPIO_DATA0_INDEX   2
#define SDIO_GPIO_DATA1_INDEX   3
#define SDIO_GPIO_DATA2_INDEX   4
#define SDIO_GPIO_DATA3_INDEX   5

#define SDIO_GPIO_MAP \
{\
	{GPIO_7, GPIO_DEV_SDIO_HOST_CLK},\
...
{ \
	...
	{GPIO_22, GPIO_DEV_PWM6},\
	{GPIO_23, GPIO_DEV_PWM7},\
...
#define GPIO_ATE_TEST_CONFIG \
{\
	{2, {GPIO_6, GPIO_8, 0xff}},\
	{2, {GPIO_19, GPIO_16, 0xff}},\
	{2, {GPIO_1, GPIO_7, 0xff}},\
	{2, {GPIO_5, GPIO_3, 0xff}},\
	{2, {GPIO_0, GPIO_20, 0xff}},\
	{3, {GPIO_4, GPIO_9, GPIO_21}},\
}

#define GPIO_ATE_TEST_LIST \
{\
	GPIO_0, GPIO_1, GPIO_3, GPIO_4, GPIO_5, GPIO_6, GPIO_7, GPIO_8, GPIO_9,\
	GPIO_16, GPIO_19, GPIO_20, GPIO_21,\
}
#endif /* CONFIG_GPIO_ATE_TEST */
