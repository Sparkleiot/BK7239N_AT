...
static inline void sys_ana_ll_set_ana_reg1_mode(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x41 << 2)), 8, 0x3, v);
}
...
static inline void sys_ana_ll_set_ana_reg2_temp_gsel(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x42 << 2)), 10, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg2_temp_gsel(void) {
	sys_ana_ana_reg2_t *r = (sys_ana_ana_reg2_t*)(SOC_SYS_ANA_REG_BASE + (0x42 << 2));
	return r->temp_gsel;
}
...
static inline void sys_ana_ll_set_ana_reg3_anabuf_sel_tx(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x43 << 2)), 10, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg3_anabuf_sel_tx(void) {
	sys_ana_ana_reg3_t *r = (sys_ana_ana_reg3_t*)(SOC_SYS_ANA_REG_BASE + (0x43 << 2));
	return r->anabuf_sel_tx;
}

static inline void sys_ana_ll_set_ana_reg3_ampbias_outen(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x43 << 2)), 11, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg3_ampbias_outen(void) {
	sys_ana_ana_reg3_t *r = (sys_ana_ana_reg3_t*)(SOC_SYS_ANA_REG_BASE + (0x43 << 2));
...
static inline void sys_ana_ll_set_ana_reg4_tdldo_bypassen(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x44 << 2)), 23, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg4_tdldo_bypassen(void) {
	sys_ana_ana_reg4_t *r = (sys_ana_ana_reg4_t*)(SOC_SYS_ANA_REG_BASE + (0x44 << 2));
	return r->tdldo_bypassen;
}

static inline void sys_ana_ll_set_ana_reg4_nc_24_25(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x44 << 2)), 24, 0x3, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg4_nc_24_25(void) {
	sys_ana_ana_reg4_t *r = (sys_ana_ana_reg4_t*)(SOC_SYS_ANA_REG_BASE + (0x44 << 2));
	return r->nc_24_25;
}
...
static inline void sys_ana_ll_set_ana_reg5_anabufsel_rx(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 0, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_anabufsel_rx(void) {
...
static inline void sys_ana_ll_set_ana_reg5_nc_2_2(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 2, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_nc_2_2(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
	return r->nc_2_2;
}

static inline void sys_ana_ll_set_ana_reg5_temp_gsel(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 3, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_temp_gsel(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
	return r->temp_gsel;
}
...
static inline void sys_ana_ll_set_ana_reg5_pwd_anabuf_lownoise(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 8, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_pwd_anabuf_lownoise(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
	return r->pwd_anabuf_lownoise;
}

static inline void sys_ana_ll_set_ana_reg5_cktst_sel(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 9, 0x3, v);
}
...
static inline void sys_ana_ll_set_ana_reg5_ck_tst_enbale(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 11, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_ck_tst_enbale(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
...
static inline void sys_ana_ll_set_ana_reg5_spilatchb_rc32k(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 13, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_spilatchb_rc32k(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
	return r->spilatchb_rc32k;
}

static inline void sys_ana_ll_set_ana_reg5_pwd_rosc_spi(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 14, 0x1, v);
}
...
static inline void sys_ana_ll_set_ana_reg5_rc32k_refclken(uint32_t v) {
	sys_ana_set_ana_reg_bit((SOC_SYS_ANA_REG_BASE + (0x45 << 2)), 15, 0x1, v);
}

static inline uint32_t sys_ana_ll_get_ana_reg5_rc32k_refclken(void) {
	sys_ana_ana_reg5_t *r = (sys_ana_ana_reg5_t*)(SOC_SYS_ANA_REG_BASE + (0x45 << 2));
...
static inline void sys_ana_ll_set_ana_reg8_rtcwk_rstn(uint32_t v) {
	sys_ana_set_ana_reg_bit_iram((SOC_SYS_ANA_REG_BASE + (0x48 << 2)), 14, 0x1, v);
}
...
static inline void sys_ana_ll_set_ana_reg11_rtcsel(uint32_t v) {
	sys_ana_set_ana_reg_bit_iram((SOC_SYS_ANA_REG_BASE + (0x4b << 2)), 24, 0xf, v);
}
...
static inline void sys_ana_ll_set_ana_reg11_timersel(uint32_t v) {
	sys_ana_set_ana_reg_bit_iram((SOC_SYS_ANA_REG_BASE + (0x4b << 2)), 28, 0xf, v);
}
...
static inline void sys_ana_ll_set_ana_reg12_timersel(uint32_t v) {
	sys_ana_set_ana_reg_bit_iram((SOC_SYS_ANA_REG_BASE + (0x4c << 2)), 0, 0xffffffff, v);
}
...
static inline void sys_ana_ll_set_ana_reg13_rtcsel(uint32_t v) {
	sys_ana_set_ana_reg_bit_iram((SOC_SYS_ANA_REG_BASE + (0x4d << 2)), 0, 0xffffffff, v);
}
