 ...
 *
 * @param wireless_mode The desired wireless mode to be configured
 *
 * @note This API is used to configure the wireless mode (e.g., 802.11b/g/n) for the station interface.
 */
