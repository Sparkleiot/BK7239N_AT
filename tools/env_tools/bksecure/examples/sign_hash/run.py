...
def main():
    ...
    if args.build:
        ...
        files = ['provision.bin', 'primary_manifest.json', 'steps_pack.json', 'partitions.csv', 'ota.csv', 'security.csv', 'root_ec256_pubkey.pem','bin.csv']
        copy_file_list(f'{idk_path}/build/{project_base}/bk7236n/_build', f'{pack_path}/immutable', files)
        files = ['security.csv', 'root_ec256_pubkey.pem', 'root_ec256_privkey.pem']
        copy_file_list(f'{idk_path}/build/{project_base}/bk7236n/_build', f'{sign_path}/immutable', files)

        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/otp_efuse_config.json', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/ota_vmin_signed.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/jump.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/bl2.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/bl2_B.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/tfm_s.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/cpu0_app.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/overwrite.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/pack_primary_manifest.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/bl1_control.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/boot_flag.bin', f'{pack_path}/_tmp')
        copy_file(f'{idk_path}/build/{project_base}/bk7236n/_build/partition.bin', f'{pack_path}/_tmp')
