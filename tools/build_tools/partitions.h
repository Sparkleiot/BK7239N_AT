...
#ifdef BK_PARTITION_BL2
#define BK_PARTITION_BOOTLOADER BK_PARTITION_BL2
#endif
...
#ifdef BK_PARTITION_PRIMARY_CPU0_APP
#define BK_PARTITION_APPLICATION BK_PARTITION_PRIMARY_CPU0_APP
#endif
