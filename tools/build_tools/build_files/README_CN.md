...
欢迎使用 Armino!
Armino 是**博通集成**推出的物联网开发框架，旨在支持**博通集成** 2022 年之后推出的各种物联网芯片， Armino 默认支持 FreeRTOS。
...
|release/v2.2.1|![alt text][支持]   |![alt text][支持]    |![alt text][开发中]    |![alt text][开发中] | sdk 2.2.1 Branch         |
